...
\hfuzz=5.002 pt % suppress overfull box warning
\hbadness=99999 % suppress underfull box warning
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{csquotes}
%cite paper title with biblatex
\newcommand{\citeWTitle}[1]{{\footnotesize\citetitle*{#1}} \cite{#1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\med}[1]{\mathrm{median}\left[ #1 \right]}
\newcommand{\Bspace}{\;\;\;\;}
...
\DeclareMathOperator{\Std}{Std} % \std for Standard deviation
\DeclareMathOperator{\sgn}{sgn} % sign of a variable
\DeclareMathOperator{\tr}{trace} % matrix trace
\DeclareMathOperator{\VarH}{Var}
